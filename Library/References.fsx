...
module Array =
    ...
    *)
    ...
    Array.sortDescending [| for i in 1 .. 5 -> -i |] // [|-1; -2; -3; -4; -5|]
    ...
    Array.tryFindBack (fun n -> n % 2 = 1)
        [| 1
           2
           3 |] // Some 3

    Array.findBack (fun n -> n % 2 = 1)
        [| 1
           2
           3 |] // 3
    (* 結果が見つからないとき *)

    Array.tryFindBack (fun n -> n > 3)
        [| 1
           2
           3 |] // None
    //Array.findBack    (fun n -> n > 3) [|1; 2; 3|]  // 例外発生「 System.Collections.Generic.KeyNotFoundException 」
    Array.tryFind (fun n -> n % 2 = 1)
        [| 1
           2
           3 |] // Some 1

    Array.find (fun n -> n % 2 = 1)
        [| 1
           2
           3 |] // 1
    ...
    Array.tryFindIndexBack (fun n -> n % 2 = 1)
        [| 1
           2
           3 |] // Some 2

    Array.tryFindIndex (fun n -> n % 2 = 1)
        [| 1
           2
           3 |] // Some 0

    Array.findIndexBack (fun n -> n % 2 = 1)
        [| 1
           2
           3 |] // 2
    ...
    let fibs n =
        Array.unfold (fun (x, y, z) -> if z > 0 then Some(x, (y, x + y, z - 1)) else None)
        <| (1, 1, n)
