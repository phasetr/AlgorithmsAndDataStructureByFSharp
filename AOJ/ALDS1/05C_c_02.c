// https://onlinejudge.u-aizu.ac.jp/solutions/problem/ALDS1_5_C/review/596603/leafmoon/C
#include <math.h>
#include <stdio.h>
#include <stdlib.h>
double p;
void drawKoch(int level, double x1, double y1, double x2, double y2){
...
int main(n){p=atan2(1,0)*2;scanf("%d",&n);puts("0 0");drawKoch(n,0,0,100,0);exit(0);}
